...
const Home = () => (
    <Container padding={"3rem 0 7rem 0"} centerContent="true">
      <Background width="80vw" height="125vh" backgroundColor={Color.BLUE}>
        <VStack>
          ...
          <Text color={Color.CREME} padding={'0px 40px 0px 40px'} textAlign="center">For hurtig hjælp ring på Tlf :  ** ** ** ** mellem 8:30 og 13:30 
